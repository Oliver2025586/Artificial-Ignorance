import { UserCheck, Star, Gift, CheckCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-neon-green/10 mb-6">
                <UserCheck className="w-10 h-10 text-neon-green" />
              </div>
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                AI <span className="text-neon-green">Concierge</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Automated guest support that delivers premium hospitality experiences
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                ...
                <p className="text-gray-400">White-glove service for every guest interaction</p>
              </div>
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                <Gift className="w-12 h-12 text-neon-green mb-4" />
                <h3 className="text-2xl font-bold mb-3">Personalized</h3>
                <p className="text-gray-400">Tailored recommendations and assistance</p>
              </div>
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                <UserCheck className="w-12 h-12 text-neon-green mb-4" />
                <h3 className="text-2xl font-bold mb-3">Always Ready</h3>
                <p className="text-gray-400">Instant assistance at any time of day</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Deliver exceptional hospitality with AI-powered concierge services
              </p>
