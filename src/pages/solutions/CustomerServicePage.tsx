import { Headphones, Clock, Globe, TrendingUp, CheckCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                Customer Service <span className="text-neon-green">AI</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Automated voice support that delivers exceptional customer experiences 24/7
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                ...
                <p className="text-gray-400">Never miss a customer inquiry with round-the-clock AI support</p>
              </div>
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                <Globe className="w-12 h-12 text-neon-green mb-4" />
                <h3 className="text-2xl font-bold mb-3">Multi-Language</h3>
                <p className="text-gray-400">Support customers in their native language instantly</p>
              </div>
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                <TrendingUp className="w-12 h-12 text-neon-green mb-4" />
                <h3 className="text-2xl font-bold mb-3">Scalable</h3>
                <p className="text-gray-400">Handle thousands of calls simultaneously without hiring more staff</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm border-2 border-neon-green rounded-2xl p-12 mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  'Instant access to customer history and order information',
                  'Automated ticket creation and issue routing',
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join hundreds of businesses providing exceptional support with AI
              </p>
