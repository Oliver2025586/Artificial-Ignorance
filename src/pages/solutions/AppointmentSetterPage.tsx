import { Calendar, Clock, Zap, CheckCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-neon-green/10 mb-6">
                <Calendar className="w-10 h-10 text-neon-green" />
              </div>
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                Appointment <span className="text-neon-green">Setter AI</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Smart scheduling AI that books appointments automatically
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                ...
                <p className="text-gray-400">Schedule appointments in real-time without delays</p>
              </div>
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                <Clock className="w-12 h-12 text-neon-green mb-4" />
                <h3 className="text-2xl font-bold mb-3">Smart Scheduling</h3>
                <p className="text-gray-400">Optimize calendar with intelligent booking logic</p>
              </div>
              <div className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl p-8 hover:border-neon-green transition-all">
                <Calendar className="w-12 h-12 text-neon-green mb-4" />
                <h3 className="text-2xl font-bold mb-3">Auto Reminders</h3>
                <p className="text-gray-400">Reduce no-shows with automated reminders</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Fill your calendar faster with AI-powered appointment setting
              </p>
