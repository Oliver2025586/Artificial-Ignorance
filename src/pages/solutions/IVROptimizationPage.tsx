...
export default function IVROptimizationPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold mb-6">
                IVR Optimization <span className="text-neon-green">AI</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Human-level accuracy in call routing</p>
            </div>
